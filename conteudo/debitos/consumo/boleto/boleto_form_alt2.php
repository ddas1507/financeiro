...
<form name="alterar_boleto" action="index.php" method="post">
	<tr >
		...
		<td >
			...
			<?php
				...
				switch($oquefazer->registros->BLT_BANCO)
				{
					...
					case '033': $Santander = 'selected'; break;
			...
			?>		
					...
					<option value="033" <?php echo $Santander;?>>Santander</option>
	...
	<tr >
		...
		<td >
			<input 
				...
				value="<?php echo $oquefazer->registros->BLT_CEDENTE;?>"
				/>
		</td>
	</tr>
	<tr>
		...
		<td >
			<input 
				...
				value="<?php echo $oquefazer->registros->BLT_CODBARBL1;?>"
			>
			<input 
				type="text" 
				...
				onkeypress="if (!isNaN(String.fromCharCode(window.event.keyCode))) return true; else return false;"
				value="<?php echo $oquefazer->registros->BLT_CODBARBL2;?>"
			>
			...
			<input 
				...
				onkeypress="if (!isNaN(String.fromCharCode(window.event.keyCode))) return true; else return false;"
				value="<?php echo $oquefazer->registros->BLT_CODBARBL3;?>"
			>
			<input 
				type="text" 
				...
				onkeypress="if (!isNaN(String.fromCharCode(window.event.keyCode))) return true; else return false;"
				value="<?php echo $oquefazer->registros->BLT_CODBARBL4;?>"
			>
			...
			<input 
				...
				onkeypress="if (!isNaN(String.fromCharCode(window.event.keyCode))) return true; else return false;"
				value="<?php echo $oquefazer->registros->BLT_CODBARBL5;?>"
			>
			<input 
				type="text" 
				...
				onkeypress="if (!isNaN(String.fromCharCode(window.event.keyCode))) return true; else return false;"
				value="<?php echo $oquefazer->registros->BLT_CODBARBL6;?>"
			>
			...
			<input 
				...
				onkeypress="if (!isNaN(String.fromCharCode(window.event.keyCode))) return true; else return false;"
				value="<?php echo $oquefazer->registros->BLT_CODBARBL7;?>"
			>
			<input 
				type="text" 
				...
				onkeypress="if (!isNaN(String.fromCharCode(window.event.keyCode))) return true; else return false;"
				value="<?php echo $oquefazer->registros->BLT_CODBARBL8;?>"
			>
		</td>		
	</tr>
	...
	<tr>
		...
		<td >
			<input 
				...
				value="<?php echo $oquefazer->registros->BLT_VALOR;?>"
			>
		</td>
	</tr>
	...
	<tr>
		...
		<td >
			<input 
				...
				onkeypress="if (!isNaN(String.fromCharCode(window.event.keyCode))) return true; else return false;"
				value="<?php echo $oquefazer->registros->BLT_DTD_EMIS;?>"
			>/
			<input 
				type="text" 
				...
				onkeypress="if (!isNaN(String.fromCharCode(window.event.keyCode))) return true; else return false;"
				value="<?php echo $oquefazer->registros->BLT_DTM_EMIS;?>"				
			>/
			<input 
				type="text" 
				...
				onkeypress="if (!isNaN(String.fromCharCode(window.event.keyCode))) return true; else return false;"
				value="<?php echo $oquefazer->registros->BLT_DTA_EMIS;?>"
			>
		</td>
	</tr>
	...
	<tr>
		...
		<td >
			<input 
				...
				onkeypress="if (!isNaN(String.fromCharCode(window.event.keyCode))) return true; else return false;"
				value="<?php echo $oquefazer->registros->BLT_DTD_VENC;?>"
			>/
			<input 
				type="text" 
				...
				onkeypress="if (!isNaN(String.fromCharCode(window.event.keyCode))) return true; else return false;"
				value="<?php echo $oquefazer->registros->BLT_DTM_VENC;?>"
			>/
			<input 
				type="text" 
				...
				onkeypress="if (!isNaN(String.fromCharCode(window.event.keyCode))) return true; else return false;"
				value="<?php echo $oquefazer->registros->BLT_DTA_VENC;?>"
			>
		</td>
	</tr>
	...
	<tr >
		...
		<td >
			<input 
				...
				value="<?php echo $oquefazer->registros->BLT_OBS;?>"
			>		
		</td>
	</tr>
	...
	<tr>
		...
		<td colspan="14">
			...
			<?php
				...
				switch($oquefazer->registros->BLT_STATUS)
				{
	...
	<tr >
		<td colspan="2" align="right">
			...
			<input type="hidden" value="modificar_boleto2" name="tabela" >
			<input type="hidden" value="modificar_boleto2" name="acao" >		
			<input type="hidden" value="<?php echo $oquefazer->registros->BLT_CODIGO;?>" name="codigo" >					
		</td>
	</tr>
</form>	
</table>