...
// inicio da Função para o campo Banco
...
// final da Função para o campo Banco
// inicio da Função para o campo Cedente
	else if(cadastrar_boleto.CAP_BLT_CEDENTE.value == ''){
		alert("O campo \"Cedente\" é obrigatório.");
		document.cadastrar_boleto.CAP_BLT_CEDENTE.focus()
		return false;
	}
// final da Função para o campo Cedente
