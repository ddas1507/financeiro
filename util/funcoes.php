...
Because updates are frequent, it is possible that these files contain additional error information not listed here."; break;
	...
	function alerta($mensagem){echo '<script>alert("'.$mensagem.'");</script>';}
	
	function Voltar($url_site){echo '<script>history.back();</script>';}
	
	function Admin($admin){echo '<script>window.location="'.$admin.'"</script>';}
